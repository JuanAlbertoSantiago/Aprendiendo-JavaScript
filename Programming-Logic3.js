...
console.log("Sean Todos Bienvenidos");

//2. Crea una variable llamada "nombre" y asígnale tu nombre. Luego, utiliza console.log para mostrar el mensaje "¡Hola, [tu nombre]!" en la consola del navegador.

let nombre = "Juan Alberto Santiago";
...
if (edad >=18){
    ...
    console.log("¡Felicidades eres muy joven, pero no eres mayor de edad :(!");
}
...
let nota = 10; //Coloca el valor de la nota que obtuviste
if (nota >= 7){
